...
function SellerDashboard() {
  ...
  useEffect(() => {
    fetch("https://marketzone-backend-production-a801.up.railway.app/products/my", {
    ...
    fetch("https://marketzone-backend-production-a801.up.railway.app/orders/seller", {
      headers: { Authorization: `Bearer ${token}` },
    })
      .then((res) => res.json())
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingProduct
        ? `https://marketzone-backend-production-a801.up.railway.app/products/update/${editingProduct.id}`
        : "https://marketzone-backend-production-a801.up.railway.app/products/add";
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`https://marketzone-backend-production-a801.up.railway.app/products/delete/${id}`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const updateStatus = async (orderId, status) => {
    try {
      await fetch(
        `https://marketzone-backend-production-a801.up.railway.app/orders/status/${orderId}?status=${status}`,
        {
          method: "PUT",
          headers: { Authorization: `Bearer ${token}` },
        }
